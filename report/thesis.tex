...
\philipp{Kannst du auch noch kurz erwähnen das die primary Chunks alle in 
verschiedenen Memory Regionen sind, grosser Unterschied zu Standard libc heap 
wo der Heap eine einzige Region ist, auch ein Bild dazu}
